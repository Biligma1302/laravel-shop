...
<nav class="navbar navbar-light bg-light mb-4">
    <div class="container">
        <a href="/products" class="navbar-brand">Laravel Shop</a>
        <a href="/products" class="nav-link {{ request()->is('products*') ? 'active fw-semibold' : '' }}">
            📦 Каталог
        </a>
        <a href="/orders" class="navbar-brand">📋 Мои заказы</a>
